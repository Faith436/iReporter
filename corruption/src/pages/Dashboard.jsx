...
import ReportList from '../components/RecentReports';
  ...
  const reports = [
    {
      ...
      description:
        "Witnessed irregularities in the bidding process for the new highway construction. Documents show inflated costs and questionable contractor selection.",
        ...
        <div key={report.id} className="report-card">
          <div className="report-header">
            ...
            <div className="report-status">
              ...
              <span className="type-badge red-flag">Red Flag</span>
            </div>
          </div>
