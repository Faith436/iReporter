                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <p className="font-semibold text-gray-800 text-sm">{notification.title || "Notification"}</p>
                          </div>
          ...
          {showUserMenu && (
            <div className="absolute right-0 mt-2 w-60 bg-white rounded-lg shadow-xl border border-gray-200 z-50">
              ...
              <ul className="py-2">
                ...
                <li onClick={logout} className="flex items-center gap-2 px-4 py-2 text-red-600 hover:bg-red-50 cursor-pointer">
