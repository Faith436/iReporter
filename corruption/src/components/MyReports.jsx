  ...
  const renderEditStep = () => {
    switch (currentStep) {
      case 1:
        return (
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-blue-900">Basic Info</h3>
      ...
      case 2:
        return (
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-blue-900">Location Details</h3>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              <label className="block font-medium text-gray-700">Coordinates</label>
              <button
                type="button"
                onClick={() =>
                  updateEditData({ coordinates: { lat: "6.5244", lng: "3.3792" } })
                }
              ...
              {editData.coordinates && (
                <div className="px-3 py-2 bg-blue-50 rounded-md border-l-4 border-blue-400 text-gray-700">
                  <strong>Current coordinates:</strong> {editData.coordinates.lat},{" "}
                  {editData.coordinates.lng}
                </div>
              )}
            </div>
          </div>
      ...
      case 3:
        return (
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-blue-900">Evidence & Additional Info</h3>
            <div className="space-y-2">
              <label className="block font-medium text-gray-700">Additional Evidence</label>
              <textarea
                    ...
                    <div className="flex justify-between mb-4 bg-white p-4 border rounded-lg">
                      {[1, 2, 3].map((step) => (
                        ...
                        >
                          ...
                          {step === 1 ? "Basic Info" : step === 2 ? "Location" : "Evidence"}
                        </div>
                      ))}
                    </div>
